...
-- The average age for all players who played more than 40 games.
	SELECT AVG(age),name FROM players WHERE games > 40;
...
-- The team and the the number of players who score above 12 points per game on that team, ordered from the most number of players to the least number of players.
	SELECT players.team, COUNT(name) FROM players WHERE points/games > 12 GROUP BY players.team ORDER BY COUNT(name) DESC;
